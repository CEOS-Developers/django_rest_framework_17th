    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='timetable.courseinfo')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='course',
            name='course_info',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='timetable.courseinfo'),
        ),
    ]
